...
class SearchActivity : AppCompatActivity() {
    ...
    private val historyOfTracksList = mutableListOf<Track>()
    private val adapter = TrackAdapter(mutableListOf())
    private val searchHistoryAdapter = TrackAdapter(mutableListOf())
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchDeleteButton.setOnClickListener {
            ...
            inputMethodManager?.hideSoftInputFromWindow(binding.searchDeleteButton.windowToken, 0)
        ...
        searchHistoryAdapter.tracks = searchHistory.searchHistoryList
    ...
    fun updateHistoryOfTracksList(position: Int) {
        if (!binding.inputEditTextSearchTracks.text.isNullOrEmpty()) {
            if (historyOfTracksList.size > 0) {
        ...
        private companion object {
            ...
            private const val SEARCH_TRACKS_HISTORY = "search_track_history"
        }
    }
